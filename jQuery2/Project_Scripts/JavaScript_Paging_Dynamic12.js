...
function SetupPaginationClass(CurrentPagingClass, PagerPageStartNumber, PagerPageHighlightNumber) {
    ...
    for (var PagerPageSliderCounter = PagerPageStartNumber; PagerPageSliderCounter < PagerPageStopNumber; PagerPageSliderCounter++) {
        if (PagerPageNumberToHighlight == PagerPageSliderCounter) {
            PaginationClass.append('<li><a href="#" class="Current_Highlight UnderLineText Italic_Text page-link NumberButton">' + PagerPageSliderCounter + '</a></li>');
        }
        else {
            PaginationClass.append('<li><a href="#" class="page-link NumberButton">' + PagerPageSliderCounter + '</a></li>');
        }
    }
...
function RemoveCSSPropertyFromSpecifiedClass(PagingObject, IndexNumberInClass) {

}

function SetCssPropertyOnSpecifiedClass(PagingObject, IndexNumberInClass) {
